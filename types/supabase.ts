  ...
  public: {
    Tables: {
      ...
      analysis_questions: {
        ...
        Relationships: [
          {
            foreignKeyName: "analysis_questions_rfp_analysis_id_fkey"
      ...
      market_research_guidance: {
        ...
        Relationships: [
          {
            foreignKeyName: "market_research_guidance_rfp_analysis_id_fkey"
            columns: ["rfp_analysis_id"]
            isOneToOne: false
            referencedRelation: "rfp_analyses"
            referencedColumns: ["id"]
      ...
      question_responses: {
        Row: {
          analysis_question_id: string | null
          created_at: string | null
          id: string
          metadata: Json | null
        ...
        Relationships: [
          {
            foreignKeyName: "question_responses_analysis_question_id_fkey"
            columns: ["analysis_question_id"]
            isOneToOne: false
            referencedRelation: "analysis_questions"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "question_responses_rfp_analysis_id_fkey"
            columns: ["rfp_analysis_id"]
            isOneToOne: false
            referencedRelation: "rfp_analyses"
            referencedColumns: ["id"]
      ...
      rfp_analyses: {
        ...
        Relationships: [
          {
            foreignKeyName: "rfp_analyses_project_id_fkey"
            columns: ["project_id"]
            isOneToOne: false
            referencedRelation: "projects"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "rfp_analyses_rfp_document_id_fkey"
            columns: ["rfp_document_id"]
            isOneToOne: false
            referencedRelation: "rfp_documents"
            referencedColumns: ["id"]
